    ...
    <Col className="box mt-2">
      <Col className='px-3'>
        <Row className='d-flex bg-light'>
          <Col lg={3} md={3} sm={3} xs={3} className="fw-bold py-2 justify-content-center">Qtd</Col>
          <Col lg={3} md={3} sm={3} xs={3} className="fw-bold py-2 px-1"> Produto </Col>
      ...
      <Col className='box px-3 mx-0 overflow-auto'>
        <Row className='d-flex'>
          <Col lg={3} md={3} sm={3} xs={3} className="py-2 justify-content-center">1x</Col>
          <Col lg={3} md={3} sm={3} xs={3} className="py-2 px-1"> Película 3D </Col>
